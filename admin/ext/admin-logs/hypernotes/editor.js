...
function SimpleTextEditor(id, objectId) {
    ...
    this.getEditorHtml = function() {
        ...
        html += '<td class="button"><img src="'+this.path+'images/bold.png" width="16" height="16" alt="Bold" title="Bold" onclick="'+this.objectId+'.execCommand(\'bold\')"></td>';
        html += '<td class="button"><img src="'+this.path+'images/italic.png" width="16" height="16" alt="Italic" title="Italic" onclick="'+this.objectId+'.execCommand(\'italic\')"></td>';
        html += '<td class="button"><img src="'+this.path+'images/underline.png" width="16" height="16" alt="Underline" title="Underline" onclick="'+this.objectId+'.execCommand(\'underline\')"></td>';
        html += '<td><div class="separator"></div></td>';
        html += '<td class="button"><img src="'+this.path+'images/left.png" width="16" height="16" alt="Align Left" title="Align Left" onclick="'+this.objectId+'.execCommand(\'justifyleft\')"></td>';
        html += '<td class="button"><img src="'+this.path+'images/center.png" width="16" height="16" alt="Center" title="Center" onclick="'+this.objectId+'.execCommand(\'justifycenter\')"></td>';
        html += '<td class="button"><img src="'+this.path+'images/right.png" width="16" height="16" alt="Align Right" title="Align Right" onclick="'+this.objectId+'.execCommand(\'justifyright\')"></td>';
        html += '<td><div class="separator"></div></td>';
        html += '<td class="button"><img src="'+this.path+'images/ol.png" width="16" height="16" alt="Ordered List" title="Ordered List" onclick="'+this.objectId+'.execCommand(\'insertorderedlist\')"></td>';
        html += '<td class="button"><img src="'+this.path+'images/ul.png" width="16" height="16" alt="Unordered List" title="Unordered List" onclick="'+this.objectId+'.execCommand(\'insertunorderedlist\')"></td>';
        html += '<td><div class="separator"></div></td>';
        html += '<td class="button"><img src="'+this.path+'images/outdent.png" width="16" height="16" alt="Outdent" title="Outdent" onclick="'+this.objectId+'.execCommand(\'outdent\')"></td>';
        html += '<td class="button"><img src="'+this.path+'images/indent.png" width="16" height="16" alt="Indent" title="Indent" onclick="'+this.objectId+'.execCommand(\'indent\')"></td>';
        html += '<td><div class="separator"></div></td>';
        html += '<td class="button"><img src="'+this.path+'images/link.png" width="16" height="16" alt="Insert Link" title="Insert Link" onclick="'+this.objectId+'.execCommand(\'createlink\')"></td>';
        html += '<td class="button"><img src="'+this.path+'images/image.png" width="16" height="16" alt="Insert Image" title="Insert Image" onclick="'+this.objectId+'.execCommand(\'insertimage\')"></td>';
        html += '<td><div class="separator"></div></td>';
        //html += '<td class="button"><img src="'+this.path+'images/help.png" width="16" height="16" alt="Help" title="Help" onclick="'+this.objectId+'.openWindow(\''+this.path+'help.html\', \'300\', \'300\')"></td>';
        html += '</tr></table></td></tr>';
