<?php /* Smarty version 2.6.0, created on 2010-02-21 16:01:27
...
<br /><br /><?php endif;  if ($this->_tpl_vars['desc'] != ''):  echo ((is_array($_tmp=@$this->_tpl_vars['desc'])) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
<br /><?php endif;  if (count ( $this->_tpl_vars['tags'] ) > 0): ?>
<br /><br />
<h4>Tags:</h4>
<div class="tags">
