...
package com.bit101.components
{
	...
	public class Panel extends Component
	{
		...
		override public function draw():void
		{
			...
			if(_color == -1)
			{
				_background.graphics.beginFill(Style.PANEL, .7);
			}
			else
			{
				_background.graphics.beginFill(_color, .7);
			}		
			_background.graphics.drawRect(0, 0, _width, _height);
			//_background.graphics.drawRoundRect(0, 0, _width, _height, 15, 15);
			_background.graphics.endFill();
			// outer border
			_background.graphics.lineStyle(0, 0x000000);
			_background.graphics.drawRect(0, 0, _width, _height);
			//_background.graphics.drawRoundRect(0, 0, _width, _height, 15, 15);
			/*
